                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-header header-bg">
                                <h3 class="card-title header-title">الاعلان الاول</h3>
                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-4 form-floating mb-3">
                                            <input type="date" class="form-control"
                                                @isset($ads->date) value="{{ $ads->date }}" @endisset
                                        ...
                                        <div class="col-sm-4 form-floating mb-3">
                                            <input required type="text" class="form-control"
                                                @isset($ads->name) value="{{ $ads->name }}" @endisset
                                        ...
                                        <div class="col-sm-4 form-floating mb-3">
                                            <input required type="text" class="form-control"
                                                @isset($ads->link) value="{{ $ads->link }}" @endisset
                                            ...
                                            <table id="example1"
                                                ...
                                                <tbody>
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            @isset($ads->img)
                                                                <img src="{{ asset('/public/' . Storage::url($ads->img)) }}"
                                                        ...
                                                        <td>
                                                            @isset($ads)
                                                                <a href="{{ route('ads.destroy', $ads->id) }}" type="submit"
