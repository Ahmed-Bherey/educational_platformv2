                ...
                <div class="row mt-1">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('bookDrive.store') }}" method="POST"
                                                ...
                                                <tbody>
                                                    @foreach ($bookDrives as $key => $bookDrive)
                                                        <tr class="odd">
                                                            ...
                                                            <td>{{ $bookDrive->date }}</td>
                                                            <td>{{ $bookDrive->name }}</td>
                                                            <td>{{ $bookDrive->notes }}</td>
                                                            <td>
                                                                <a href="{{ route('bookDrive.edit', $bookDrive->id) }}"
                                                                    type="submit" class="btn bg-secondary"><i
                                                                        class="far fa-edit" aria-hidden="true"></i></a>
                                                                <a href="{{ route('bookDrive.destroy', $bookDrive->id) }}"
